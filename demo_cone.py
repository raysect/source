...
# Fun example
# cone = Cone(height=0.3, material=schott("N-BK7"), parent=world, transform=translate(0, -0, 0) * rotate(2.5, 178, 0))

cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(1.5, 1.5, 0) * rotate(0, 0, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(0, 1.5, 0) * rotate(0, 45, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(-1.5, 1.5, 0) * rotate(0, 90, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(1.5, -0, 0) * rotate(0, 150, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(0, -0, 0) * rotate(0, 180, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(-1.5, -0, 0) * rotate(0, 225, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(1.5, -1.5, 0) * rotate(20, 0, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(0, -1.5, 0) * rotate(45, 0, 0))
cone = Cone(material=schott("N-BK7"), parent=world, transform=translate(-1.5, -1.5, 0) * rotate(90, 0, 0))
