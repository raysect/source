...
class TestInterpolatorLoadNormalValuesUneven(TestInterpolatorLoadValues):
    ...
    def __init__(self):
        ...
        #: array holding precalculated quadratic extrapolation data.
        self.precalc_extrapolation_quadratic: np.array = np.array(
            [5.179071695997E+01, 2.257375358577E+01, 5.310181265777E+00, 1.177315104261E+00,
             1.423567886565E+00, 1.580229331721E+00], dtype=np.float64
        )

    def setup_cubic(self):
        self.precalc_interpolation = np.array(
            [0.000000000000E+00, 3.447892239860E-02, 6.888595610588E-02, 1.032544472771E-01,
             1.375151618421E-01, 1.715051987275E-01, 2.053821752921E-01, 2.390832684721E-01,
             2.723068439295E-01, 3.053012580170E-01, 3.380820336964E-01, 3.702222303437E-01,
             4.019532994654E-01, 4.334382552562E-01, 4.642127774571E-01, 4.943144535500E-01,
             5.241229709276E-01, 5.532612433794E-01, 5.814060851293E-01, 6.091900509354E-01,
             6.363749101431E-01, 6.623049641892E-01, 6.877434743987E-01, 7.126518253545E-01,
             7.361528897742E-01, 7.589523114242E-01, 7.812650650538E-01, 8.021605767910E-01,
             8.219108308568E-01, 8.414709848079E-01], dtype=np.float64
        )
