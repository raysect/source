...
class PinholeCamera(Camera):
    ...
    def __init__(self, pixels=(512, 512), fov=45, sensitivity=1.0, spectral_samples=20, spectral_rays=1,
                 pixel_samples=100, process_count=cpu_count(), parent=None,
    ...
    def _generate_rays(self, ix, iy, ray_template):
        ...
        point_generator = Rectangle(self.image_delta, self.image_delta)
        points = point_generator(self.pixel_samples)
