...
# from raysect.core import AffineMatrix
# from raysect.optical.material.glass_libraries import Schott
# from raysect.primitive.lens.old.sphericalsinglets import generic_spherical_singlet
#
# # infinity constant
# INFINITY = 1e999
#
...
#     def __init__(self):
#         try:
#             plano_convex_file = open(resource_filename("raysect", "optical/library/components/data/plano-convex.csv"), "r")
