...
from raysect.optical.observer import PinholeCamera, CCDArray, FibreOptic
from raysect.optical.observer import SpectralPipeline0D, PowerPipeline0D
from raysect.core.workflow import SerialEngine

power = PowerPipeline0D()

camera = FibreOptic(parent=world, transform=translate(0, 0, -3.3) * rotate(0, 0, 0), pipelines=[power])
camera.acceptance_angle = 10
...
print(power.value.mean, power.value.error())