...
# Parabola(radius=1000, height=0.1, parent=world, material=Dielectric(ConstantSF(1.4), ConstantSF(1.0)), transform=translate(0, 0, 0) * rotate(0, 0, 0))
...
Box(Point3D(-50.0, -50.0, 0.5), Point3D(50.0, 50.0, 0.6), world, material=Checkerboard(0.02, d65_white, d65_white, 0.4, 0.8))
